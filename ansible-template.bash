...
complete -W 'list archive blockinfile command copy fetch file get_url group lineinfile script service shell synchronize systemd template unarchive user' ansible-template ansi-template ansi-tmplt
